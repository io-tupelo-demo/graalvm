...
ls -ldF *  0.00s user 0.00s system 61% cpu 0.010 totalbash
```
...
Goodbye...
 ...
 409346048  maximum resident set size
...
Goodbye...
   ...
   2560000  maximum resident set size
       657  page reclaims
         4  involuntary context switches
```

So we see that the maximem RSS memory requirement was reduced from 409 Mb to 2 Mb.  **Yes, an
improvement over 200x!**
